  ...
  return (
      <div style={{ width: "90%", margin: "auto", alignItems: "center" }}>
        <Carousel>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid2} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid4} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid5} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid6} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid8} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid9} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid10} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={masjid11} alt="Third slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
