    ...
    <div className="homeScreen">
      <Fade>
        <div className="homeScreen__top">
          <h4>
           Ushbu Web-sahifa Toshkent viloyati Angren shahri Qora'bog' jome masjidi rasmiy sayti hisoblanadi <a href='https://t.me/Angren_Masjid_Official'>Telegram kanalimiz</a>
          </h4>
        </div>
      </Fade>
      <Fade>
