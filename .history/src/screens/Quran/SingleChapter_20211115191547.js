...
export const SingleChapter = ({  loading, setLoading }) => {
  const [page, setPage] = useState(1);
  const [search, setSearch] = useState("");

  const fetchedQuran = useSelector((state) => state.quran.quran);
              ...
              <>
                <Table>
                  <TableHead style={{ backgroundColor: "#eebc10" }}>
                    <TableRow>
                      {["Suralar", "Nomi", "Tarjima", "Nuzul joyi"].map(
                        (head) => (
                          <TableCell
                            style={{
                              color: "black",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <span style={{ color: "darkgrey" }}>{name}</span>
                            </div>
                          </TableCell>
                          ...
                          <TableCell align="right">{revelationType}</TableCell>
                        </TableRow>
                      );
                    })}
                  </TableBody>
