    ...
    <div className="Bx">
      <div className="popular__ones">
        ...
        <div className="container__box">
          ...
          <div className="bx">
            <a href='http://tafsirihilol.uz/' style={{textDecoration: 'none', color: 'black'}}>Yosin</span>
          </div>
          <div className="bx">
            <a href='http://tafsirihilol.uz/' style={{textDecoration: 'none', color: 'black'}}>Taborak</span>
          </div>
        </div>
      </div>
      <div>
