...
export const SingleAyah = ({ ayah }) => {
  ...
  return (
    <Container style={{ paddingTop: 40 }}>
      ...
      <div>
        <p><span>Qur'onidagi hizb-</span><span>{hizbQuarter}</span></p>
        <p><span>Qur'onidagi manzili-</span><span>{manzil}</span></p>
        <p><span>Qur'onidagi juzi-</span><span>{juz}</span></p>
        <p><span>Qur'onidagi rukusi-</span><span>{ruku}</span></p>
