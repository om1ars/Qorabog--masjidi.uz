...
function HomeScreen() {
  ...
  return (
    <div className="homeScreen" style={{position: 'relative'}}>
      <div className="messengers" style={{position: 'absolute', top: '15%', cursor: 'pointer', left: 10, position: 'fixed', zIndex: 9999, display: 'flex', flexDirection: 'column'}}>
      ...
      <Fade>
        <div className="homeScreen__bottom">
          <div className="homeScreen__bottomLeft" style={{display: 'flex', flexDirection: 'column'}}>
            <h4>Qorabog' jome masjidi bosh Imom hatibi</h4>
