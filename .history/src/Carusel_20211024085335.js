  ...
  return (
      <div style={{ width: "90%", margin: "auto", alignItems: "center" }}>
        <Carousel>
          ...
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={https://lh5.googleusercontent.com/p/AF1QipOF81m2qYnDoC2SXggCIWLcO-SLjzToxg1u4ByT=w426-h240-k-no} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
              <h3>First slide label</h3>
              <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
