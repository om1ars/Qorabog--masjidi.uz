  ...
  },
  {
    ...
    type: "medinan",
    total_verses: 286,
    verse: 'Вторая сура Священного Корана «Аль-Бакара» (в переводе с арабского – «Корова») относится к мединскому периоду жизни Пророка Мухаммада (с.г.в.). Это самая длинная сура в Коране – в ней 286 аятов.
