  ...
  },
  {
    ...
    type: "medinan",
    total_verses: 286,
    verse: 'Вторая сура Священного Корана «Аль-Бакара» (в переводе с арабского – «Корова») относится к мединскому периоду жизни Пророка Мухаммада (с.г.в.). Это самая длинная сура в Коране – в ней 286 аятов.Аллах ниспослал аяты «Коровы» после хиджры Посланника Всевышнего (с.г.в.) в Медину. Начало её текста является своего рода продолжением первой, «открывающей» суры Корана «Аль-Фатиха». Здесь более подробно раскрываются мысли, изложенные в предыдущей суре. «Аль-Бакара» напоминает нам о том, что только Коран является основным руководством для мусульман. В суре рассказывается о тех благах, которые Аллах своей милостью даровал верующим.Также в аятах подробно описана и участь безбожников. В первой части суры упомянуты три категории людей:
