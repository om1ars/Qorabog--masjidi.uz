      ...
      <div style={{ width: "90%", margin: "auto", alignItems: "center" }}>
        <Carousel>
          <Carousel.Item interval={5000} onPause>
            <img className="d-block w-100" src={masjid} alt="First slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={masjid} alt="Third slide" style={{borderRadius: 12}} />
            <Carousel.Caption>
